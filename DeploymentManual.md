...
4. Задание:
    - файлы токенов каждого документа с tf-idf информацией в директории result/task4/tokens/
    - файлы лемм каждого документа с tf-idf информацией в директории result/task4/lemmas/
5. Задание:
    - в логах топ 10 релевантных исходных документов
